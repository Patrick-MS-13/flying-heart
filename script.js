...
function init() {
  ...
  var text = new createjs.Text("Be single", "bold " + getTextSize() + "px Arial", "#312");
...
//  Do not close your eyes. I need you to feel the heat between us, whether we're together or away...